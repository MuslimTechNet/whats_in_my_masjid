...
class LocalStorageService {
  ...
  static const String LatitudeKey = 'darkTheme';
  static const String LongitudeKey = 'useLocationKey';
...
class UserPreferences {
  ...
  UserPreferences(
      {this.darkTheme, this.useLocationKey, this.latitude, this.longitude});
